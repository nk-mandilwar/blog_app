...
ActiveRecord::Schema.define(version: 20160930085421) do
  ...
  create_table "subscribes", force: :cascade do |t|
    ...
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
    t.integer  "security_question", limit: 4,   default: 0
    t.string   "security_ans",      limit: 255
  end
  ...
  add_index "users", ["city"], name: "city", using: :btree
